                        ...
                        <div class="team-slider team-list">
                            <ul>
                                <li class="d-sm-flex">
                                    ...
                                    <div class="team-text">
                                        <h4 class="h4-md mb-3 fw-6 txt-blue">Your Gateway to the Global Markets</h4>
                                        <p>Gain access to a wide range of shares in US, Australia and Hong Kong. LSC allows you to both long (buy) and short (sell) many of these shares, including participating in the dividends and interests of holding these positions</p>
                                    </div>
                                </li>
                            </ul>
