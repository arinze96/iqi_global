                        ...
                        <div class="team-slider team-list">
                            <ul>
                                <li class="d-sm-flex">
                                    ...
                                    <div class="team-text">
                                        <h4 class="h4-md mb-3 fw-6 txt-blue">Why Trade CFDs on Indices</h4>
                                        <p>Did you know that trading indices can get you exposure to a country’s stock market performance?
                                            <br>
