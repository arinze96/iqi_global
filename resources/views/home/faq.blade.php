...
<link href="{{ asset('assets/css1/animate.css') }}" rel="stylesheet" type="text/css">
<link href="{{ asset('assets/css1/font-awesome.min.css') }}" rel="stylesheet" type="text/css">
<link href="{{ asset('assets/css1/owl-carousel.css') }}" rel="stylesheet" type="text/css">
<link href="{{ asset('assets/css1/meanmenu.css') }}" rel="stylesheet" type="text/css">
        ...
        <div class="container">
            <div class="row" style="padding-top: 50px">
                <div class="col-md-12 col-sm-12 faq-heading">
                    <h2 style="color: white">Frequent questions</h2>
                    <p style="color: white">If you couldn't find answer on your questions,<br> please contact our 24/7 live chat customer
                        support.</p>
                </div>
                <!--col-md-12-->
            </div>
                                ...
                                <div class="panel-body">
                                    <div class="col-md-8">
                                        <p> Minimum purchase amounts differs for every contract, you may find it on our
                                            ...
                                            to contact a manager at support@Iqiglobalfx.com or in our live chat.
                                        </p>
                                    </div>
                                </div>
                            </div>
