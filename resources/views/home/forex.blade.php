                        ...
                        <div class="team-slider team-list">
                            <ul>
                                <li class="d-sm-flex">
                                    ...
                                    <div class="team-text">
                                        <h4 class="h4-md mb-3 fw-6 txt-blue">Why Trade CFDs on Forex?</h4>
                                        <p>The Foreign Exchange market is the largest and most liquid market in the world with a daily trade volume of over $6.5 trillion dollars, eclipsing the likes of the New York Stock Exchange which by comparison, has a trading volume of only $20+ billion per day.

                                            It is also the market that caters to all traders no matter which part of the world you may live in as it’s open 24 hours a day, 5 days a week.</p>
                                    </div>
                                </li>
                            </ul>
                            ...
                            <div class="tabbable">
                                <ul id="tab" class="nav nav-tabs">
                                    ...
                                    <li class="nav-item"> <a href="#tab-content-2" data-toggle="tab"
                                            class="nav-link">Forex</a> </li>
                                </ul>
                                <div id="tab-content" class="tab-content">
                                    <div id="tab-content-1" class="tab-pane fade active show">
                                        <div class="no-mg-b">We always ensure you get the best trading conditions with our deep liquidity and lightning speed execution technology.</div>
                                    </div>
