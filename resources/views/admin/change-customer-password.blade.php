            ...
            <div class="page-content">
				...
				<div class="row">
					<div class="col-xl-6 mx-auto">
						<h6 class="mb-0 text-uppercase" style="text-align: center ">Change Pauline's Password</h6>
						<hr/>
							...
							<div class="card-body p-5">
								<form class="row g-3">
                                    <div class="col-md-12">
										...
										<input type="password" class="form-control" id="inputLastName" placeholder="Enter Password">
									</div>
                                    <div class="col-md-12">
