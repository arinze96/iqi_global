            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xl-12 mx-auto">
                        ...
                        <!--end breadcrumb-->
                        <h6 class="mb-0 " style="color: gainsboro">This is the list of all customers</h6>
                        <hr />
                                            ...
                                            <tbody>
                                                @foreach ($users as $key => $user)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a
                                                                href="{{ route('admin.users.view', ['edit-customer-profile', $user->id]) }}"><i
                                                            ...
                                                            <a
                                                                href="{{ route('admin.users.view', ['view-profile', $user->id]) }}"><i
                                                                    class="fa fa-eye" aria-hidden="true"></i></a>
                                                        </td>

                                                        <td>
                                                            <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                                <span><i class="fa fa-ellipsis-h" aria-hidden="true"></i></span></a>
                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                {{-- <li><a data-action="approve" data-type="deposit"
                                                                    class="dropdown-item"
                                                                    href="{{ route('admin.users.view', ['change-customer-password', $user->id]) }}"> Change Password</a>
                                                            </li> --}}
                                                                @if ($user->status == 1)
                                                                    <li><a data-action="suspend" data-type="profile"
                                                                            class=" dropdown-item decline_approve"
                                                                            href="{{ route('admin.users.view', ['suspend', $user->id]) }}">Suspend</a>
                                                                    </li>
                                                                @else
                                                                    <li><a data-action="activate" data-type="profile"
                                                                            class=" dropdown-item decline_approve"
                                                                ...
                                                                @if ($user->role == 1)
                                                                    <li><a data-action=" unmake admin"
                                                                            ...
                                                                            Admin</a></li>
                                                                @else
                                                                    <li><a data-action="make admin" data-type="profile"
                                                                            class="dropdown-item decline_approve"
