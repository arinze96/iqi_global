                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="tb-tnx-action">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                <li><a data-action="approve" data-type="deposit" class="dropdown-item decline_approve" href="{{ route('admin.deposit.view', ['approve', $deposit->id]) }}"><i
                                                                            class="bx bx-user"></i><span>Approve</span></a>
                                                                </li>
                                                                <li><a data-action="decline" data-type="deposit" class="dropdown-item decline_approve" href="{{ route('admin.deposit.view', ['decline', $deposit->id]) }}"><i
